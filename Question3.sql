...
insert into reservation(flightnumber)values ('1');

insert into reservation(flightnumber)values ('1');

insert into reservation(flightnumber)values ('1');
insert into passenger(passportnumber,name) values(454452,'malek');

insert into passengerreservation(reservationnumber,passportnumber,ticketnumber) values(1,454452,null);
insert into passengerreservation(reservationnumber,passportnumber,ticketnumber) values(3,454452,null);

insert into booking(price,reservationnumber,seatnumber) values (10,1,4);
insert into booking(price,reservationnumber,seatnumber) values (10,2,6);
